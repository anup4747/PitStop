  ...
  return (
    <div className="team-page">
      ...
      <header className="team-header">
        ...
        <p>
          The engineers, telemetry analysts, and racers behind Pitstop
          Solutions. Hover over any member to inspect their bio, track
          telemetry, and direct contacts.
        </p>
      </header>
      ...
      <aside className="team-join-banner">
        <div className="join-content">
          ...
          <p>
            We are scouting mechanical engineers, CNC fabricators, and telemetry
            coders for our 2026 racing calendar.
          </p>
        </div>
